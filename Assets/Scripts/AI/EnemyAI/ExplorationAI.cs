...
public class ExplorationAI : MonoBehaviour
{
    ...
    {
        EventBus.Subscribe<EnemyAIEvents.ExecuteExplorationPhaseEvent>(OnExplorePhase);
    }

    private void OnDisable()
    {
        EventBus.Unsubscribe<EnemyAIEvents.ExecuteExplorationPhaseEvent>(OnExplorePhase);
    }

    private void OnExplorePhase(EnemyAIEvents.ExecuteExplorationPhaseEvent evt)
    {
